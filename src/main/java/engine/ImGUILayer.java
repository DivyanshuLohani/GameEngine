    ...
    public void initImGui() {
        ...
        glfwSetKeyCallback(glfwWindow, (w, key, scancode, action, mods) -> {
            ...
            if (!io.getWantCaptureKeyboard()){
                KeyListener.keyCallback(glfwWindow, key, scancode, action, mods);
            }
        });
        ...
        glfwSetMouseButtonCallback(glfwWindow, (w, button, action, mods) -> {
            ...
            if (!io.getWantCaptureMouse() || GameViewWindow.getWantCaptureMouse()){
                MouseListner.mouseButtonCallback(glfwWindow, button, action, mods);
            }
        });
...
//
        ...
        fontAtlas.addFontFromFileTTF("assets/fonts/Osworld.ttf", 25, fontConfig);
...
//        ImGuiFreeType.buildFontAtlas(fontAtlas, ImGuiFreeType.RasterizerFlags.LightHinting);
    ...
    private void setupDoking(){
        int windowFlags = ImGuiWindowFlags.MenuBar | ImGuiWindowFlags.NoDocking;

        ImGui.setNextWindowPos(0, 0, ImGuiCond.Always);
        ImGui.setNextWindowSize(Window.getWidth(), Window.getHeight());
        ImGui.pushStyleVar(ImGuiStyleVar.WindowRounding, 1.0f);
